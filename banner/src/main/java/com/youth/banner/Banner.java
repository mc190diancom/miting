...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorNoSelectedWidth;
    private int mIndicatorSelectedHeight;
    private int mIndicatorNoSelectedHeight;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        //mIndicatorNoSelectedWidth = typedArray.getDimensionPixelSize(R.styleable.indicator_no_selected_width, indicatorSize);
        mIndicatorSelectedHeight = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_selected_height, indicatorSize);
        //mIndicatorNoSelectedHeight = typedArray.getDimensionPixelSize(R.styleable.indicator_no_selected_height, indicatorSize);
