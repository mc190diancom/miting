...
public class CustomHelloTIMUIController {
    ...
    public static void onDraw(final  Context context,ICustomMessageViewGroup parent, final CustomMessage data) {

        // 把自定义消息view添加到TUIKit内部的父容器里
        View view = LayoutInflater.from(context).inflate(R.layout.test_custom_message_layout1, null, false);
