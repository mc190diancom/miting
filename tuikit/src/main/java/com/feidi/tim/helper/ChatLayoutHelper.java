...
import static com.feidi.tim.helper.CustomMessage.JSON_VERSION_1_HELLOTIM;
...
//        ////// 设置气泡 ///////
//        // 设置自己聊天气泡的背景
        messageLayout.setRightBubble(layout.getContext().getDrawable(R.drawable.live_room_chat_myself_bg));
//        // 设置朋友聊天气泡的背景
        messageLayout.setLeftBubble(layout.getContext().getDrawable(R.drawable.live_room_chat_bg));
//
//        ////// 设置聊天内容 //////
//        // 设置聊天内容字体字体大小，朋友和自己用一种字体大小
        messageLayout.setChatContextFontSize(13);
//        // 设置自己聊天内容字体颜色
        messageLayout.setRightChatContentFontColor(layout.getContext().getResources().getColor(R.color.white));
//        // 设置朋友聊天内容字体颜色
        messageLayout.setLeftChatContentFontColor(layout.getContext().getResources().getColor(R.color.chat_color));
//
//        ////// 设置聊天时间 //////
//        // 设置聊天时间线的背景
...
//        // 设置聊天时间的字体颜色
        //   messageLayout.setChatTimeFontColor(R.color.chat_color);
//
//        ////// 设置聊天的提示信息 //////
//        // 设置提示的背景
        messageLayout.setTipsMessageBubble(layout.getContext().getDrawable(R.drawable.live_room_chat_tip_bg));
//        // 设置提示的字体大小
        messageLayout.setTipsMessageFontSize(13);
//        // 设置提示的字体颜色
        messageLayout.setTipsMessageFontColor(layout.getContext().getResources().getColor(R.color.chat_tip_color));
//
        // 设置自定义的消息渲染时的回调
...
//        inputLayout.addAction(videoCall);
    ...
    public static class CustomInputFragment extends BaseInputFragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
            ...
            Button btn1 = (Button) baseView.findViewById(R.id.test_send_message_btn1);
            ...
            Button btn2 = (Button) baseView.findViewById(R.id.test_send_message_btn2);
    ...
    public class CustomMessageDraw implements IOnCustomMessageDrawListener {
        ...
        public void onDraw(ICustomMessageViewGroup parent, MessageInfo info) {
            ...
            try {
                ...
                Log.e(TAG, "invalid json: " + new String(elem.getData()) + " " + e.getMessage());
            }
            if (data == null) {
                ...
                Log.e(TAG, "unsupported version: " + data.version);
            }
        }
    }
