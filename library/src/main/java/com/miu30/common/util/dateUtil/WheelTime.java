package com.miu30.common.util.dateUtil;

import android.view.View;

import com.miu30.common.util.dateUtil.adapter.ArrayWheelAdapter;
import com.miu30.common.util.dateUtil.adapter.NumericWheelAdapter;
import com.miu30.common.util.dateUtil.listener.ISelectTimeCallback;
import com.miu30.common.util.dateUtil.listener.OnItemSelectedListener;
import com.miu30.common.util.dateUtil.util.ChinaDate;
import com.miu30.common.util.dateUtil.util.LunarCalendar;
import com.miu30.common.util.dateUtil.view.WheelView;
...
//                maxItem = endD;
    ...
    private void setReHour(int startHour) {
        if (startYear == endYear && startMonth == endMonth && startDay == endDay) {
            wv_hours.setAdapter(new NumericWheelAdapter(startHour, endHour));
        } else {
    ...
    public String getTime() {
        ...
        int hour;
        if (startDay == wv_day.getCurrentItem() + startDay) {
