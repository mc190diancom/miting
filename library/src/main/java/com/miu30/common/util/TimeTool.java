...
public class TimeTool {
    ...
    public static final SimpleDateFormat yyyyMMdd2 = new SimpleDateFormat("yyyyMMdd");
    ...
    public static Date getYYHHmmss(String date) {
        try {
            Date parse = yyyyMMdd_HHmmss.parse(date);
            return parse;
        } catch (ParseException e) {
            e.printStackTrace();
            return new Date();
    ...
    public static String formatHH_mm_ss(long timeStr) {
        try {
            return HH_mm_ss.format(new Date(timeStr));
        } catch (Exception e) {
            return "";
        }
    }

    public static String formatHH_mm_ss2(long timeStr) {
        try {
            if(timeStr >= 57600000){
                return "23:59:59";
            }
    ...
    public static String formatyyyyMMdd_HHmmByStr(String timeStr) {
        try {
            Date parse = yyyyMMddHHmm.parse(timeStr);
            return yyyyMMdd_HHmm.format(parse);
        } catch (Exception e) {
            return timeStr;
        }
    }

    public static String formatyyyyMMdd_HHmmssByStr(String timeStr) {
        try {
            Date parse = yyyyMMddHHmmss.parse(timeStr);
            return yyyyMMdd_HHmm.format(parse);
        } catch (Exception e) {
            return "无";
        }
    ...
    public static String formatyyyyMMddHHmmssByStr(String timeStr) {
        try {
            Date parse = yyyyMMdd_HHmm.parse(timeStr);
            return yyyyMMddHHmmss.format(parse);
        } catch (Exception e) {
            return "无";
        }
    }

    public static String formatyyyyMMdd_HHmmss(long timeStr) {
        try {
            if(timeStr != 0 && timeStr < 1E10){
                timeStr = timeStr * 1000;
            }
            return yyyyMMdd_HHmmss.format(new Date(timeStr));
        } catch (Exception e) {
     ...
     * @return yyyy-MM-dd
     */
    public static String onlineCarDateFormat(String srcDate) {
        try {
            return yyyyMMdd.format(yyyyMMdd2.parse(srcDate));
        } catch (Exception e) {
            return "无";
        }
    }
