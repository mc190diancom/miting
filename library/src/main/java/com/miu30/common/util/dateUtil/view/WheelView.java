package com.miu30.common.util.dateUtil.view;
...
import com.miu30.common.util.dateUtil.IPickerViewData;
import com.miu30.common.util.dateUtil.adapter.WheelAdapter;
import com.miu30.common.util.dateUtil.listener.LoopViewGestureListener;
import com.miu30.common.util.dateUtil.listener.OnItemSelectedListener;
import com.miu30.common.util.dateUtil.timer.InertiaTimerTask;
import com.miu30.common.util.dateUtil.timer.MessageHandler;
import com.miu30.common.util.dateUtil.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private static final float SCALE_CONTENT = 1.2F;//非中间文字则用此控制高度，压扁形成3d错觉
