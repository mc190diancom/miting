...
//            Intent intent = new Intent(App.self, QHSdk.class);
//            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            App.self.startService(intent);
            /*AlarmManager mgr = (AlarmManager) App.self.getSystemService(Context.ALARM_SERVICE);
            Intent intent = new Intent("com.lubao.remote");
            intent.setPackage("com.miu360.qhsdk");
            PendingIntent restartIntent = PendingIntent.getService(App.self, 0, intent, PendingIntent.FLAG_ONE_SHOT);
...
*/
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "Launcher_CRS_" + time + "_" + imei + ".txt";
            ...
            File cacheDir = new File(Environment.getExternalStorageDirectory().getPath() + "/inspect/"+File.separator+"Launcher_Log");
