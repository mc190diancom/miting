...
public class RegisterInfoNew {
	...
	public String getWycHylb() {
		return wycHylb;
	}

	public void setWycHylb(String wycHylb) {
		this.wycHylb = wycHylb;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegisterInfoNew other = (RegisterInfoNew) obj;
		if (address == null) {
