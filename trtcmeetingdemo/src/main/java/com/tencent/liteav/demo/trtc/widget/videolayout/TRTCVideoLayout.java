...
class TRTCVideoLayout extends RelativeLayout implements View.OnClickListener {
    ...
    ArrayList<TRTCVideoLayoutManager.TRTCLayoutEntity> mLayoutEntityList;
    ...
    public void setEntityList(ArrayList<TRTCVideoLayoutManager.TRTCLayoutEntity> layoutEntityList){
        mLayoutEntityList = layoutEntityList;
    }
    ...
    private void initFuncLayout() {
        ...
        //mRecycleView = (RecyclerView) mVgFuc.findViewById(R.id.rv_video_layout);
        //initRecycleView();
