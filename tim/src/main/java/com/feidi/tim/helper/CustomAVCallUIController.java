...
//        mTRTCCloud.setListener(TRTCListener.getInstance());
    ...
    public void onDraw(ICustomMessageViewGroup parent, CustomMessage data) {
        ...
        View view = LayoutInflater.from(MiuBaseApp.self).inflate(R.layout.test_custom_message_av_layout1, null, false);
    ...
    private String createCallID() {
        ...
        sb.append(Config.SDKAPPID).append("-").append(TIMManager.getInstance().getLoginUser()).append("-");
        for (int i = 0; i < 32; i++) {
    ...
    private void startC2CConversation(CustomMessage message) {
        ...
        Intent intent = new Intent(MiuBaseApp.self, ChatActivity.class);
